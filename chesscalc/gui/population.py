    ...
    def calculate_population_map(self):
        ...
        for e, p in enumerate(population_maps):
            ...
            if len(rep):
                ...
                pc.append(''.join(
                    ('\nNo players in link populations played oppenents ',
                     'in their link population.',
                     )))
            ...
            if len(rest_players) == 0:
                ...
                msg = ''.join(
                    ('\nEach player in the remainder population played at ',
                     ...
                     'The number of players in the remainder population is: ',
                     ))
                allmsg = ''.join(
                    ('\nThe number of all opponents of players in the ',
                ...
                restmsg = ''.join(
                    ('\nThe number of remainder opponents of players in the ',
                     'remainder population is: ',
                     ))
            else:
                msg = ''.join(
                    ('\nEach player in a remainder population played at most ',
                     str(e),
                     ' opponents from the whole population, including at ',
                     'least one opponent from a link population but no ',
                     'opponents from a core population.\nThe numbers of ',
                ...
                restmsg = ''.join(
                    ('\nThe numbers of remainder opponents of players in the ',
                     'remainder populations are: ',
                     ))
            pc.append(msg)
            rep = [''.join(('\n\t', str(k), ': ', str(v)))
            ...
            if len(rep):
                ...
                pc.append(''.join(
                    ('\nNo players in remainder populations played oppenents ',
                     'in their remainder population.',
                     )))
            # start rest_opps_link
            # This section should give same figures as 'link_opps_rest'
            # Remove it?
            pc.append(''.join(
                ('\nThe number of opponents of remainder players in the ',
                 'link populations are: ',
                 )))
            rep = [''.join(
                ('\n\t',
